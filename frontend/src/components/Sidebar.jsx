...
export default function Sidebar({ files, onUpload, onSelectFile, onBack, notebookTitle }) {
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                    {files.map(f => (
                        <div
                            key={f.id}
                            className="card"
                            style={{ padding: 12, display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer', boxShadow: 'none', border: '1px solid transparent' }}
